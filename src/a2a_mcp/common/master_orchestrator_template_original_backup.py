...
🚨 DEPRECATED: This template is deprecated in favor of the new architecture:
   - Enhanced Planner Agent (for all planning tasks)  
   - Lightweight Master Orchestrator (for execution coordination)
...
Migration Guide:
Replace:  MasterOrchestratorTemplate(...)
With:     LightweightMasterOrchestrator(...)

See: /ORCHESTRATOR_ARCHITECTURE_COMPARISON.md for details

This file will be removed in a future Framework V2.0 release.
...
class MasterOrchestratorTemplate(StandardizedAgentBase):
    ...
    def __init__(
        ...
        warnings.warn(
            "MasterOrchestratorTemplate is deprecated. "
            "Use LightweightMasterOrchestrator + EnhancedGenericPlannerAgent instead. "
            "See ORCHESTRATOR_ARCHITECTURE_COMPARISON.md for migration guide.",
            DeprecationWarning,
            stacklevel=2
        )
