#!/usr/bin/env python3
"""Clean MCP server based on working reference pattern."""
...
def serve(host, port, transport):  # noqa: PLR0915
    ...
    logger.info(f'Clean Agent cards MCP Server at {host}:{port} and transport {transport}')
    mcp.run(transport=transport)


if __name__ == "__main__":
    # For testing
    serve('localhost', 10102, 'sse')